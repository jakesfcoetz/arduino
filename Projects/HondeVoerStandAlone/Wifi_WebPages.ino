...
String html_Head() {
  String htmlHead = "<!DOCTYPE html> <html>\n";
    ...
    htmlHead +="<title>Coetzee Auto Feeder</title>\n";
...
String html_Root() {
  ...
  html_text +="<body>\n";
  html_text +="<h1>Honde Voer - " + unitName + "</h1>\n";
...
String html_Unit() {
  String html_text = html_Head();
  html_text += "<body>";
  html_text += "<h1>Honde Voer - " + unitName + " - Unit</h1>";
...
String html_Time() {
  String html_text = html_Head();
  html_text +="<body>\n";
  html_text +="<h1>Honde Voer - " + unitName + " - Time</h1>\n";
